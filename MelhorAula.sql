...
ALTER TABLE ITENS_ALUNO_CURSO
ADD CONSTRAINT Pk_COMPOSTA PRIMARY KEY (CODALUNO_FK, CODCURSO_FK);
...
-- quais os cursos que cada aluno faz?
SELECT *
FROM ALUNO 
INNER JOIN ITENS_ALUNO_CURSO 
ON ALUNO.CODALUNO = ITENS_ALUNO_CURSO.CODALUNO_FK
INNER JOIN CURSO 
ON ITENS_ALUNO_CURSO.CODCURSO_FK = CURSO.CODCURSO; 
...
SELECT aluno.codaluno as "Código do Aluno", 
